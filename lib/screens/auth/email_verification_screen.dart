...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // User needs to be created before checking
  ...
  Future<void> checkEmailVerified() async {
    ...
    if (mounted) {
      ...
      if (isEmailVerified) {
        print("Email verified, preparing to navigate to onboarding");
        ...
        Future.delayed(const Duration(seconds: 2), () {
          if (mounted) {
            print("Navigating to onboarding flow now");
            // Navigate to the existing onboarding welcome screen
